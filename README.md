...
mvn archetype:generate -DarchetypeGroupId=fi.utu.ville.exercises -DarchetypeArtifactId=vexer-archetype -DarchetypeVersion=0.2.3-RELEASE -DarchetypeRepository=http://www.mvn.villeteam.net

3.2. For the Leveled stub run:

mvn archetype:generate -DarchetypeGroupId=fi.utu.ville.exercises -DarchetypeArtifactId=vexer-archetype-mathlayout -DarchetypeVersion=0.2.3-RELEASE -DarchetypeRepository=http://www.mvn.villeteam.net
