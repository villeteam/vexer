...
public class AbstractMathSubmissionStatisticsGiver<E extends ExerciseData, F extends LevelMathSubmissionInfo<G>, G extends Problem>
	...
	protected void doLayout() {
		...
		this.setComponentAlignment(tableWrapper, Alignment.MIDDLE_CENTER);
		this.setComponentAlignment(statistics, Alignment.MIDDLE_CENTER);
		this.setComponentAlignment(horStats, Alignment.MIDDLE_CENTER);
