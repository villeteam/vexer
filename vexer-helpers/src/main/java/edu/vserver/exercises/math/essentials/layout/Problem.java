...
public interface Problem extends Serializable {
	...
	/**
	 * Determines the correctness of this problem by comparing 
	 * the correct answer to the answer given by the user.
	 * 
	 ...
	 * 
	 * @return	true if this problem has already been solved correctly, 
	 * 			false if tryAnswer has not been called or the user's answer was wrong.
	 */
