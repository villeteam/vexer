...
/**
 * An implementor of this class knows how to execute certain exercise-instance
 * defined by certain {@link ExerciseData} of given exercise-type.
 * 
 * @author Riku Haavisto, Johannes Holvitie
 * 
 * @param <E>
 *            {@link ExerciseData} instances of which can be executed with this
 *            implementor
 * @param <S>
 *            {@link SubmissionInfo} in which this executor stores info about
 *            submissions
 */
public interface Executor<E extends ExerciseData, S extends SubmissionInfo>
	...
	/**
	 * Loads the executor with data. This method must be called before calling
	 * other methods of the executor to initialize the executor.
	 * 
	 * @param localizer
	 ...
	 * @param oldSubm
	 *            {@link SubmissionInfo} of old submission that can be shown to
	 *            the user (optional); null if there is no prior submission
	 * @param tempManager
	 *            {@link TempFilesManager} giving access to a private
	 *            temporary-folder if needed
	 * @param execSettings
	 *            {@link ExecutionSettings} that might affect how the
	 *            {@link Executor} should behave
	 * @throws ExerciseException
	 *             if something goes wrong in the initialization (eg. a failure
	 *             to fetch critical resources)
	 */
	...
	/**
	 * @return The GUI through which the user can execute certain
	 *         exercise-instance
	 */
	Component getView();
	...
	/**
	 * <p>
	 * Informs the {@link Executor} that it will be shut-down and it should
	...
	/**
	 * Listeners registered through this method are called whenever the
	 * {@link ExecutionState} of the executor changes.
	 * 
