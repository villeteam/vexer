...
/**
 * <p>
 * A class for representing a single column of tabular data with certain title,
 * description, type and a list of values (or rows).
 * </p>
 * <p>
 * Multiple {@link StatisticsInfoColumn}s can parsed for same set of input-data
 * can be combined to form a table from multiple sources.
 * </p>
 * 
...
public final class StatisticsInfoColumn<A> {
	 ...
	 * @param exportable
	 *            boolean telling whether it makes sense to export data from
	 *            this column to external tools
	 */
	...
	/**
	 * @return list of data-values corresponding to this column parsed from some
	 *         input data
	 */
	...
	/**
	 * @return true if the data in this column is exportable to general format
	 *         (eg. Excel or csv)
	 */
