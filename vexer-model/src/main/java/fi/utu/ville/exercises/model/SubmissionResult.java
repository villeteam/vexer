...
/**
 * This class encapsulates needed information about a submission made to a
 * certain exercise.
 * 
...
public final class SubmissionResult<S extends SubmissionInfo> implements
	 ...
	 * @param timeOnTask
	 *            time on task in seconds (from submission to submission;
	 *            reseting the exercise state should not reset the timer)
	 * @param additionalData
	 *            exercise-type specific additional info as a suitable
	...
	/**
	 * @return time on task in seconds (from submission to submission; reseting
	 *         the exercise state should not reset the timer)
	 */
	...
	/**
	 * @return {@link SubmissionInfo}-object containing exercise-type specific
	 *         data recording info about the submission
	 */
	...
	/**
	 * @return an optional {@link Component} that can be shown as a visual
	 *         feedback to the user who made the submission
	 */
