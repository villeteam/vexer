...
class StubStyleSettingsEditor extends VerticalLayout implements
	...
	private final static String[] FONTS = { "sans-serif", "serif", "monospace",
			"cursive", "fantasy" };
	private final static String[] FONT_SIZES = { "100%", "75%", "120%", "8px",
			"10px", "12px", "13px", "14px", "16px", "18px", "20px", "22px",
			"24px", "26px", "30px", "36px", "40px", "56px", "72px", "96px" };
	...
	/**
	 * Copies the style settings from the dialog to the object associated with
	 * this dialog
	 */
	@Override
